...
namespace Fosol.Common.ServiceModel.Behaviors
{
        ...
        : BehaviorExtensionElement
    {
        ...
        [TypeConverter(typeof(Fosol.Common.Converters.AssemblyTypeConverter))]
        public Type ErrorHandlerType 
        {
            ...
            set
            {
                if (value != null)
                {
                    Fosol.Common.Validation.Property.Assert.IsTrue(value.IsStatic(), "ErrorHandlerType", "Type must be static.");
                }
