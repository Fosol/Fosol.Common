...
namespace Fosol.Common.ServiceModel.Validation
{
    public static class Assert
    {
        ...
        public static void IsNotNull(object value, string paramName, string message = null)
        {
            ...
            if (value == null)
                throw new Faults.ParameterNullFault(paramName, string.Format(message ?? Resources.Strings.Validation_Assert_IsNotNull, paramName)).Raise();
        }
        #endregion
        ...
        public static void IsTrue(bool value, string paramName, string message = null)
        {
            ...
            if (!value)
                throw new Faults.ParameterFault(message ?? String.Format(Resources.Strings.Validation_Assert_IsTrue, paramName), paramName).Raise();
        }
        #endregion
        ...
        public static void IsValue<T>(T value, T[] validValues, string paramName, string message = null)
        {
            ...
            if (!validValues.Contains(value))
                throw new Faults.ParameterOutOfRangeFault(paramName, string.Format(message ?? Resources.Strings.Validation_Assert_IsValue, paramName)).Raise();
        }
        ...
        public static void IsValue<T>(T value, T validValue, string paramName, string message = null)
        {
            ...
            if (!value.Equals(validValue))
                throw new Faults.ParameterOutOfRangeFault(message ?? string.Format(Resources.Strings.Validation_Assert_IsValue, paramName), paramName).Raise();
        }
        #endregion
    }
}
