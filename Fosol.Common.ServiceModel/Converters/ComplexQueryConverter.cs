...
namespace Fosol.Common.ServiceModel.Converters
{
    /// <summary>
        ...
        : QueryStringConverter
    {
        ...
        public override object ConvertStringToValue(string parameter, Type parameterType)
        {
            ...
            if (parameterType.IsArray || typeof(System.Collections.IList).IsAssignableFrom(parameterType))
            {
                ...
                {
                    var values = parameter.Split(DEFAULT_KEYVALUE_DELIMITER, true);
                ...
                {
                    var values = parameter.SplitToKeyValuePair(DEFAULT_KEYVALUE_DELIMITER, this.KeyValueDelimiter, true);
