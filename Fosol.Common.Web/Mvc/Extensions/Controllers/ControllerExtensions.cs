...
namespace Fosol.Common.Web.Mvc.Extensions.Controllers
{
    /// <summary>
    /// ControllerExtensions static class contains a list of extension methods for the Controller class.
    /// </summary>
    public static class ControllerExtensions
    {
        ...
        public static ActionResult RedirectToLocal(this Controller controller, string returnUrl, string defaultRouteName = "Default")
        {
            ...
            RouteValueDictionary routeValues = Helpers.RouteValuesHelper.MergeRouteValues(controller.RouteData.Values, default_route.Defaults);
