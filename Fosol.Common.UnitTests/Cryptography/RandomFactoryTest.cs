...
{
    [TestClass]
    public sealed class RandomFactoryTest
    {
        #region Variables
        #endregion
        ...
        {
            var salt = Fosol.Common.Cryptography.RandomFactory.GenerateSalt(32);
        ...
        {
            var salt = Fosol.Common.Cryptography.RandomFactory.GenerateSalt(8);
        ...
        {
            var salt = Fosol.Common.Cryptography.RandomFactory.GenerateSalt(4);
