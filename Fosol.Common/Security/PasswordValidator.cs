...
{
    /// <summary>
    /// PasswordValidator provides methods to assit in password generation and testing.
    /// 
    /// Initialize a new instance of PasswordValidator with your password requirements, then use the Validate() method to validate any password.
    /// </summary>
    public sealed class PasswordValidator
    {
        ...
        #region Constructors
        public PasswordValidator(PasswordRequirement requirements)
        {
        ...
        /// <summary>
        /// Creates a new PasswordValidator object.
        /// </summary>
        ...
        public PasswordValidator(int minLength, int maxLength, int minRequiredNonalphaDigitCharacters, int minRequiredLowercaseCharacters, int minRequiredUppercaseCharacters, int minRequiredDigitCharacters)
        {
        ...
        public PasswordValidator(string passwordStrengthRegularExpression)
        {
