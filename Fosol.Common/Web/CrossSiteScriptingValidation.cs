...
{
    /// <summary>
    /// CrossSiteScriptingValidation provides a way to test string values for cross site scripting syntax.
    /// </summary>
    public static class CrossSiteScriptingValidation
    {
        ...
        public static bool IsDangerousString(string value)
        {
            ...
            return CrossSiteScriptingValidation.IsDangerousString(value, out pos);
        }
        ...
        public static bool IsDangerousString(string value, out int matchIndex)
        {
            ...
            while (true)
            {
                ...
                if (c != '&')
                {
                    if (c == '<' && (CrossSiteScriptingValidation.IsAlphabetic(value[pos + 1])
                        || value[pos + 1] == '!'
                        || value[pos + 1] == '/'
                        || value[pos + 1] == '?'))
                        return true;
