...
namespace Fosol.Common.Validation
{
    ...
    public sealed class AssertPassword
    {
        ...
        public AssertPassword(int minLength, int maxLength, int minRequiredNonalphanumericCharacters, int minRequiredLowerCaseCharacters, int minRequiredUpperCaseCharacters, int minRequiredNumericCharacters)
            : this(AssertPassword.CreatePasswordStrengthRegularExpression(minLength, maxLength, minRequiredNonalphanumericCharacters, minRequiredLowerCaseCharacters, minRequiredUpperCaseCharacters, minRequiredNumericCharacters))
        {
            ...
            if (maxLength > 0)
            {
                ...
                Fosol.Common.Validation.Assert.MaxRange(minRequiredNumericCharacters, maxLength, "minRequiredNumericCharacters");
                Fosol.Common.Validation.Assert.MaxRange(minRequiredNonalphanumericCharacters + minRequiredLowerCaseCharacters + minRequiredUpperCaseCharacters + minRequiredNumericCharacters, maxLength, "maxLength", "Parameter 'maxLength' is not large enough to accept your other minimum requirements.");
            }
        ...
        public bool Validate(string password)
        {
            ...
            return AssertPassword.IsValid(password, _PasswordStrengthRegularExpression);
        }
        ...
        public void Validate(string password, string paramName, string message = null)
        {
            AssertPassword.IsValid(password, _PasswordStrengthRegularExpression, paramName, message);
        }
        ...
        public static void IsValid(string password, string passwordStrengthRegularExpression, string paramName, string message = null)
        {
            ...
            if (!AssertPassword.IsValid(password, passwordStrengthRegularExpression))
                throw new ArgumentNullException(paramName, string.Format(message ?? Resources.Strings.Exception_Validation_AssertPassword_IsValid, paramName));
        }

        /// <summary>
        /// Creates a regular expression the validates the specified rules.
        /// </summary>
        /// <exception cref="System.ArgumentOutOfRangeException">Parameters 'minLength', 'maxLength', 'minRequiredLowerCaseCharacters', 'minRequiredUpperCaseCharacters', 'minRequiredNumericCharacters', 'minRequiredNonalphanumericCharacters' cannot be less than zero.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">Parameters 'maxLength' must be creater than the sum of the other minimum requirements.</exception>
        ...
        public static string CreatePasswordStrengthRegularExpression(int minLength, int maxLength, int minRequiredNonalphanumericCharacters, int minRequiredLowerCaseCharacters, int minRequiredUpperCaseCharacters, int minRequiredNumericCharacters)
        {
            Fosol.Common.Validation.Assert.MinRange(minLength, 0, "minLength");
            Fosol.Common.Validation.Assert.MinRange(maxLength, 0, "maxLength");
            Fosol.Common.Validation.Assert.MinRange(minRequiredNonalphanumericCharacters, 0, "minRequiredNonalphanumericCharacters");
            ...
            if (maxLength > 0)
            {
                ...
                Fosol.Common.Validation.Assert.MaxRange(minRequiredUpperCaseCharacters, maxLength, "minRequiredUpperCaseCharacters");
                Fosol.Common.Validation.Assert.MaxRange(minRequiredNumericCharacters, maxLength, "minRequiredNumericCharacters");
                Fosol.Common.Validation.Assert.MaxRange(minRequiredLowerCaseCharacters + minRequiredUpperCaseCharacters + minRequiredNumericCharacters + minRequiredNonalphanumericCharacters, maxLength, "maxLength", "Parameter 'maxLength' is not large enough to accept your other minimum requirements.");
            }
