...
namespace Fosol.Common.Exceptions
{
        ...
        : Exception
    {
        ...
        public AttributeRequiredException(Type attributeType)
            : base(String.Format(Resources.Multilingual.Exception_Validation_Argument_HasAttribute, attributeType.GetType().Name))
        {
        ...
        public AttributeRequiredException(Type attributeType, Exception innerException)
            : base(String.Format(Resources.Multilingual.Exception_Validation_Argument_HasAttribute, attributeType.GetType().Name), innerException)
        {
            this.AttributeType = attributeType;
        }
