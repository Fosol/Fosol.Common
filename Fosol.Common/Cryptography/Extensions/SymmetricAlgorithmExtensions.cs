...
namespace Fosol.Common.Cryptography.Extensions
{
    /// <summary>
    ...
    public static class SymmetricAlgorithmExtensions
    {
        ...
        public static int[] GetValidIVSizes(this SymmetricAlgorithm algorithm)
        {
        ...
        public static bool ValidIVSize(this SymmetricAlgorithm algorithm, int bitLength)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
        ...
        public static bool ValidIVSize(this SymmetricAlgorithm algorithm, byte[] iv)
        {
        ...
        public static int[] GetValidKeySizes(this SymmetricAlgorithm algorithm)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
        ...
        public static bool ValidKeySize(this SymmetricAlgorithm algorithm, byte[] key)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
        ...
        public static byte[] Encrypt(this SymmetricAlgorithm algorithm, byte[] data, string password, byte[] salt, int iterations = 1000)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
        ...
        /// <returns>Encrypted data.</returns>
        public static byte[] Encrypt(this SymmetricAlgorithm algorithm, byte[] data, DeriveBytes derive)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
            Fosol.Common.Validation.Argument.Assert.IsNotNullOrEmpty(data, "data");
            Fosol.Common.Validation.Argument.Assert.IsNotNull(derive, "derive");
        ...
        /// <returns>Encrypted data.</returns>
        public static byte[] Encrypt(this SymmetricAlgorithm algorithm, byte[] data, byte[] key = null, byte[] iv = null)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
            Fosol.Common.Validation.Argument.Assert.IsNotNullOrEmpty(data, "data");
            ...
            {
                Fosol.Common.Validation.Argument.Assert.IsTrue(algorithm.ValidKeySize(key), "key", "Parameter 'key' size is invalid.");
                algorithm.Key = key;
            }
            ...
            {
                Fosol.Common.Validation.Argument.Assert.IsTrue(algorithm.ValidIVSize(iv), "iv.Length", "Parameter 'iv' length is not a legal initialization vector size.");
                algorithm.IV = iv;
            }
        ...
        public static byte[] Decrypt(this SymmetricAlgorithm algorithm, byte[] data, string password, byte[] salt, int iterations = 1000)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
            Fosol.Common.Validation.Argument.Assert.IsNotNullOrEmpty(data, "data");
            Fosol.Common.Validation.Argument.Assert.IsNotNullOrWhiteSpace(password, "password");
        ...
        /// <param name="derive">DeriveBytes object.</param>
        /// <returns>Decrypted data.</returns>
        public static byte[] Decrypt(this SymmetricAlgorithm algorithm, byte[] data, DeriveBytes derive)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
            Fosol.Common.Validation.Argument.Assert.IsNotNullOrEmpty(data, "data");
            Fosol.Common.Validation.Argument.Assert.IsNotNull(derive, "derive");
        ...
        /// <param name="iv">Algorithm initialization vector.</param>
        /// <returns>Decrypted data.</returns>
        public static byte[] Decrypt(this SymmetricAlgorithm algorithm, byte[] data, byte[] key = null, byte[] iv = null)
        {
            Fosol.Common.Validation.Argument.Assert.IsNotNull(algorithm, "algorithm");
            Fosol.Common.Validation.Argument.Assert.IsNotNullOrEmpty(data, "data");
