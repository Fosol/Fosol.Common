...
namespace Fosol.Common.Formatters.Keywords
{
    ...
    public sealed class FormatKeywordPropertyAttribute
        : Attribute
    {
        #region Variables
        ...
        public FormatKeywordPropertyAttribute(string name)
        ...
        public FormatKeywordPropertyAttribute(string name, bool isRequired)
        ...
        public FormatKeywordPropertyAttribute(string name, Type converterType, params object[] converterArgs)
        ...
        /// <param name="converterType">TypeConverter to use to convert configuration values.</param>
        /// <param name="converterArgs">Arguments to supply to the TypeConverter.</param>
        public FormatKeywordPropertyAttribute(string name, bool isRequired, Type converterType, params object[] converterArgs)
        ...
        public FormatKeywordPropertyAttribute(string name, string[] abbrev)
        ...
        /// <param name="converterType">TypeConverter to use to convert configuration values.</param>
        /// <param name="converterArgs">Arguments to supply to the TypeConverter.</param>
        public FormatKeywordPropertyAttribute(string name, string[] abbrev, Type converterType, params object[] converterArgs)
        ...
        /// <param name="converterArgs">Arguments to supply to the TypeConverter.</param>
        public FormatKeywordPropertyAttribute(string name, string[] abbrev, bool isRequired, Type converterType, params object[] converterArgs)
        {
