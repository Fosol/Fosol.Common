        ...
        public CDataConfigurationElement()
        {
            ...
            foreach (var property in properties)
            {
                ...
                if (attributes == null || attributes.Length == 0)
                    throw new ConfigurationErrorsException(string.Format(Resources.Strings.Exception_Attribute_Required, "ConfigurationPropertyAttribute"));
                else if (cdata_attributes == null || cdata_attributes.Length == 0)
                    throw new ConfigurationErrorsException(string.Format(Resources.Strings.Exception_Attribute_Required, "CDataConfigurationPropertyAttribute"));
